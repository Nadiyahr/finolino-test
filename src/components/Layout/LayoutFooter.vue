<template> 
  <footer class="c-footer">
    <div class="grid grid--tablet grid--desktop u-mb-center">
      ...
      <div class="grid__item grid__item--1-2 grid__item--tablet-1-3 grid__item--desktop-6-7">
        <h6 v-if="isMobile">About us</h6>
        <FooterList v-else title="About" :list="about" />
      </div>
      <div class="grid__item grid__item--1-2 grid__item--tablet-4-6 grid__item--desktop-8-9">
        <h6 v-if="isMobile" >Privacy policy</h6>
         <FooterList v-else title="Help" :list="help" />
      </div>
      <div class="grid__item grid__item--1-2 grid__item--tablet-7-11 grid__item--desktop-10-12">
